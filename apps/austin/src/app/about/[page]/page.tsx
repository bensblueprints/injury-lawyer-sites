    ...
    <>
      <PageHeroSection imageSrc="/images/about-team.webp" imageAlt="Personal injury law team">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-300 max-w-3xl">Austin Injury Law Group — aggressive personal injury attorneys serving Austin and all of Central Texas. No fee unless we win.</p>
