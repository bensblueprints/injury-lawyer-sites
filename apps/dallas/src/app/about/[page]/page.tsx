...
const ABOUT_PAGES = [
  { slug: "our-firm", title: "About Dallas Injury Law Group" },
  { slug: "our-attorneys", title: "Our Dallas Injury Attorneys" },
  { slug: "our-results", title: "Our Results for Dallas Clients" },
  { slug: "client-reviews", title: "Client Reviews & Testimonials" },
  { slug: "community", title: "Our Dallas Community Commitment" },
  { slug: "no-fee-guarantee", title: "Our No-Fee-Unless-We-Win Guarantee" },
  { slug: "about-us", title: "About Dallas Injury Law Group" },
  { slug: "why-choose-us", title: "Why Choose Dallas Injury Law Group" },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!page) return {};
  return {
    title: `${page.title} | Dallas Injury Law Group`,
    description: `${page.title} — Dallas Injury Law Group. Aggressive personal injury representation throughout the DFW Metroplex. Call (214) 555-0183.`,
    alternates: { canonical: `https://dallastexasinjurylawyer.com/about/${params.page}` },
  };
}
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <article className="lg:col-span-2">
            <p className="text-xl text-gray-700 mb-8">
              Dallas Injury Law Group is a personal injury firm dedicated to fighting for
              accident victims throughout Dallas, Plano, Irving, Arlington, and all of the
              DFW Metroplex. We handle every case on a contingency fee basis — you pay
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                Our Commitment to Dallas Injury Victims
              </h2>
              <p className="text-gray-700 leading-relaxed">
                When you hire Dallas Injury Law Group, you get a team that&apos;s genuinely
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                Why DFW Injury Victims Choose Us
              </h2>
