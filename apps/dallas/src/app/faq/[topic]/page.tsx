...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!topic) return {};
  return {
    title: `Dallas ${topic.title} | Dallas Injury Law Group`,
    description: `Answers to the most common questions about ${topic.title.toLowerCase()} from Dallas Injury Law Group. Call (214) 555-0183 for a free consultation.`,
    alternates: { canonical: `https://dallastexasinjurylawyer.com/faq/${params.topic}` },
  };
}
...
const BASE_FAQS = [
  {
    ...
    answer:
      "Nothing upfront. Dallas Injury Law Group works on contingency — you pay nothing unless we win your case. Our fee is a percentage of your recovery.",
  },
  {
    question: "How long do I have to file a personal injury claim in Texas?",
    answer:
      "Texas generally allows two years from the date of injury for most personal injury claims. Government entity claims may have shorter deadlines. Contact us immediately at (214) 555-0183.",
  },
  {
    question: "What should I do immediately after an accident in Dallas?",
    answer:
      "Call 911, seek medical attention, document the scene with photos, collect witness information, and do not give recorded statements to insurers. Then call us at (214) 555-0183.",
  },
  {
  ...
  {
    question: "What types of damages can I recover in a Dallas personal injury case?",
    answer:
  ...
  {
    question: "Do I have to go to court for a personal injury case in Dallas?",
    answer:
  ...
  {
    question: "How do I choose the right Dallas personal injury attorney?",
    answer:
      "Look for attorneys who specialize in personal injury, work on contingency, have verifiable client reviews, and demonstrate a track record of results. Dallas Injury Law Group offers free consultations.",
  },
];
...
export default function FAQTopicPage({ params }: Props) {
  ...
  return (
    <>
      <HeroSection
        config={siteConfig}
        headline={`Dallas ${topic.title}`}
        subheadline="Get clear, honest answers about Dallas personal injury law from experienced attorneys who fight for injury victims throughout the DFW Metroplex."
        compact
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <article className="lg:col-span-2">
            <p className="text-xl text-gray-700 mb-8">
              These are the most common questions we receive at Dallas Injury Law Group. If
              you don&apos;t see your question answered here, call us at (214) 555-0183 for a
              free consultation with a Dallas injury attorney.
            </p>
            ...
            <div className="mt-10">
              <CTABox
                ...
                body="Our Dallas injury attorneys are available 24/7. Free consultation — no obligation, no upfront fees."
                variant="red"
              />
            </div>
          </article>
