...
export const metadata: Metadata = {
  title: "Free Consultation | Dallas Injury Law Group",
  description:
    "Request your free case consultation with Dallas Injury Law Group. No obligation. No upfront fees. We respond within 15 minutes. Call (214) 555-0183.",
  alternates: {
    canonical: "https://dallastexasinjurylawyer.com/free-consultation",
  },
};
  ...
  return (
    <>
      <HeroSection
        ...
        subheadline="No obligation, no upfront fees. A Dallas injury attorney will review your case personally and explain your options. We respond within 15 minutes."
        compact
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Fill out the form below and a Dallas injury attorney will contact you within
