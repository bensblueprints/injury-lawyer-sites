...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `Learn about ${topic.title.toLowerCase()} from experienced Dallas personal injury attorneys. Free consultation. Call (214) 555-0183.`,
    alternates: { canonical: `https://dallastexasinjurylawyer.com/legal-process/${params.topic}` },
  };
}
  ...
  return (
    <>
      <HeroSection
        ...
        subheadline="Dallas Injury Law Group guides you through every step of the Texas personal injury legal process. We handle everything so you can focus on recovery."
        compact
      />
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <article className="lg:col-span-2 prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 mb-8 not-prose">
              Understanding {topic.title.toLowerCase()} is essential for Dallas injury victims
              who want to protect their rights and maximize their compensation. Dallas Injury
              Law Group has guided hundreds of clients through this process throughout the
              DFW Metroplex.
            </p>
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                How Dallas Injury Law Group Handles {topic.title}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Our Dallas attorneys manage every aspect of {topic.title.toLowerCase()} on
            ...
            <div className="not-prose mt-10">
              <CTABox
                ...
                body="Our Dallas attorneys explain every step in plain English. Free consultation — no obligation."
                variant="red"
              />
            </div>
          </article>
