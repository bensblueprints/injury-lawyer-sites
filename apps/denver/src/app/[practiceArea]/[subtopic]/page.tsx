...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://devnercoloradoinjurylawyer.com/${params.practiceArea}/${params.subtopic}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://devnercoloradoinjurylawyer.com/${params.practiceArea}/${params.subtopic}`,
    },
  };
}
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <article className="lg:col-span-2">
                ...
                {i === 0 && (
                  <div className="my-8 rounded-xl overflow-hidden shadow-md">
                    <Image
                      ...
                      alt={`${content.title} attorney in Denver`}
                      width={1536}
                      height={1024}
            ...
            <div className="mt-10">
              <CTABox
                config={siteConfig}
                headline={`Injured in Denver? Get a Free ${content.title} Consultation`}
              ...
              <section className="mt-10">
                ...
                <RelatedPages
                  pages={siblingsInParent.map((s) => ({
                    title: s.label,
                    href: `/${params.practiceArea}/${s.slug}`,
                    excerpt: `Learn about ${s.label.toLowerCase()} cases in Denver, Colorado.`,
                  }))}
                />
              </section>
            )}
