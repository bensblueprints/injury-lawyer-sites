...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://devnercoloradoinjurylawyer.com/about/${content.slug}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://devnercoloradoinjurylawyer.com/about/${content.slug}`,
    },
  };
}
          ...
          <article className="lg:col-span-2">
              ...
              <section className="mt-10 bg-gray-50 rounded-2xl p-8 border border-gray-100">
                ...
                <div className="grid sm:grid-cols-3 gap-6">
                  {[
                    ...
                    { stat: "500+", label: "Colorado Cases Handled" },
            ...
            <div className="mt-10">
              <CTABox
                ...
                body="Call or contact us today for a free, confidential consultation with an experienced Denver personal injury attorney."
              />
            </div>
          </article>
