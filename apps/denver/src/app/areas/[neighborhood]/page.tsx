...
import { Breadcrumbs, CTABox, Sidebar } from "@injury/ui";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://devnercoloradoinjurylawyer.com/areas/${content.slug}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://devnercoloradoinjurylawyer.com/areas/${content.slug}`,
    },
  };
}
      ...
      <section className="bg-gradient-to-br from-gray-950 via-gray-900 to-red-950 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mt-4 mb-4">
            ...
            <span className="text-red-400">{content.name}</span>, Colorado
          </h1>
          ...
          <article className="lg:col-span-2">
            ...
            <section className="mt-10">
              ...
              <p className="text-gray-600 mb-5">
                ...
                {content.name} residents and visitors under Colorado law. Click any practice area
                below to learn more.
              </p>
            ...
            <div className="mt-10">
              <CTABox
                config={siteConfig}
                headline={`Injured in ${content.name}? Call Denver Injury Law Group`}
                body="We serve all of Metro Denver and Colorado. Free consultation. No fee unless we win."
              />
            </div>
          </article>
