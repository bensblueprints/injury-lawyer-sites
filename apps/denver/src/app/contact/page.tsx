...
export const metadata: Metadata = {
  title: "Contact Us – Denver Injury Law Group",
  description:
    "Contact Denver Injury Law Group for a free case consultation. Call (303) 555-0174, email us, or visit our office at 1700 Lincoln St, Suite 2000, Denver, CO 80203.",
  alternates: {
    canonical: "https://devnercoloradoinjurylawyer.com/contact",
  },
  openGraph: {
    title: "Contact Denver Injury Law Group",
    description:
      "Reach our Denver personal injury attorneys 24/7. Free consultations — no fee unless we win.",
    url: "https://devnercoloradoinjurylawyer.com/contact",
  },
};
      ...
      <section className="bg-gradient-to-br from-gray-950 via-gray-900 to-red-950 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white mt-4 mb-4">
            Contact Denver Injury Law Group
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-500 text-sm mb-6">
              Fill out the form below and a member of our Denver team will contact you within
