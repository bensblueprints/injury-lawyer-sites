...
export const metadata: Metadata = {
  metadataBase: new URL("https://devnercoloradoinjurylawyer.com"),
  title: {
    default: "Denver Injury Lawyer | Denver Injury Law Group",
    template: "%s | Denver Injury Lawyer",
  },
  ...
  keywords: [
    ...
    "Aurora injury lawyer",
    "Lakewood injury attorney",
    "no fee unless we win Denver",
  ],
  ...
  openGraph: {
    ...
    title: "Denver Injury Lawyer | Denver Injury Law Group",
    description: siteConfig.description,
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Denver Injury Law Group – Aggressive Personal Injury Attorneys",
      },
    ],
  },
  twitter: {
...
const localBusinessSchema = {
  ...
  image: "https://devnercoloradoinjurylawyer.com/og-image.jpg",
  sameAs: [
    "https://www.facebook.com/denverinjurylawgroup",
    "https://www.instagram.com/denverinjurylawgroup",
  ],
  aggregateRating: {
