...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://lasvegasnevadainjurylawyer.com/${content.slug}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://lasvegasnevadainjurylawyer.com/${content.slug}`,
    },
  };
}
...
export default function PracticeAreaPage({ params }: Props) {
  ...
  return (
    <>
      ...
      {/* Page header */}
      <PageHeroSection practiceAreaSlug={params.practiceArea} imageAlt={`${content.title} lawyer in Las Vegas`}>
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          ...
          <article className="lg:col-span-2">
            ...
            <div className="mt-10">
              <CTABox
                config={siteConfig}
                headline={`Need a ${content.title} in Las Vegas?`}
