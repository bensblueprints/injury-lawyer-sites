...
import { FAQ_TOPIC_SLUGS, getFAQContent } from "@/content/faq";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://lasvegasnevadainjurylawyer.com/faq/${content.slug}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://lasvegasnevadainjurylawyer.com/faq/${content.slug}`,
    },
  };
}
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Home",
        item: "https://lasvegasnevadainjurylawyer.com",
      },
      {
        "@type": "ListItem",
        position: 2,
        name: "FAQ",
        item: "https://lasvegasnevadainjurylawyer.com/faq",
      },
      {
        "@type": "ListItem",
        position: 3,
        name: content.title,
        item: `https://lasvegasnevadainjurylawyer.com/faq/${content.slug}`,
      },
    ],
  };
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12">
          <CTABox
            config={siteConfig}
            headline="Still Have Questions? Talk to a Las Vegas Injury Attorney."
            body="Our attorneys provide free consultations — no obligation, no pressure, just honest advice about your case."
          />
        </div>
        ...
        <section className="mt-12">
          <h2 className="text-xl font-black text-gray-900 mb-4">
            More Las Vegas Injury Law FAQs
          </h2>
          <div className="grid sm:grid-cols-2 gap-3">
            {[
              ...
              { label: "Nevada Injury Law", href: "/faq/nevada-injury-law" },
            ]
