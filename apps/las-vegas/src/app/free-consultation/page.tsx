...
export const metadata: Metadata = {
  title: "Free Consultation – Las Vegas Personal Injury Lawyer",
  description:
    "Get a free, no-obligation consultation with an experienced Las Vegas personal injury attorney. No fee unless we win. Available 24/7. Call (702) 555-0147.",
  alternates: {
    canonical: "https://lasvegasnevadainjurylawyer.com/free-consultation",
  },
  openGraph: {
    title: "Free Consultation – Las Vegas Injury Law Group",
    description:
      "Start your free case review today. Our Las Vegas personal injury attorneys respond within 15 minutes.",
    url: "https://lasvegasnevadainjurylawyer.com/free-consultation",
  },
};
...
const trustSignals = [
  {
    ...
    body: "Your consultation is completely free. You owe us nothing unless we win your case.",
  },
  {
  ...
  },
  {
    ...
    body: "127 verified five-star reviews from real Las Vegas and Southern Nevada clients.",
  },
  {
    icon: <Award className="w-6 h-6 text-red-400" />,
    title: "$50M+ Recovered",
    body: "Our attorneys have secured over fifty million dollars for Southern Nevada injury victims.",
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                Our Las Vegas personal injury attorneys are available 24 hours a day,
                7 days a week. Tell us what happened and we'll give you an honest
                assessment of your case — at no cost and with no pressure.
              </p>
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8">
              ...
              <p className="text-xs text-gray-400 text-center mt-4 leading-relaxed">
                By submitting this form, you agree to be contacted by Las Vegas Injury Law Group
            ...
            {[
              {
                ...
                body: "A member of our team reaches out within 15 minutes to discuss your case.",
              },
              {
                step: "2",
                title: "Free Attorney Review",
                body: "A senior attorney reviews your case details and explains your legal options honestly.",
              },
              {
                step: "3",
                title: "We Go to Work",
