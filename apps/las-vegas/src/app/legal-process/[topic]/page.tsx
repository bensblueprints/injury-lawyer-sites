...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://lasvegasnevadainjurylawyer.com/legal-process/${content.slug}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://lasvegasnevadainjurylawyer.com/legal-process/${content.slug}`,
    },
  };
}
        ...
        <div className="grid lg:grid-cols-3 gap-10">
          <article className="lg:col-span-2">
            ...
            <div className="mt-10">
              <CTABox
                config={siteConfig}
                headline="Have Questions About the Legal Process?"
                body="Our attorneys explain your options clearly and guide you every step of the way. Free consultation, no obligation."
              />
            </div>
              ...
              <section className="mt-10">
                ...
                <RelatedPages
                  pages={relatedTopics.slice(0, 8).map((p) => ({
                    title: p.label,
                    href: p.href,
                    excerpt: `A guide to understanding ${p.label.toLowerCase()} in Nevada personal injury cases.`,
                  }))}
                />
              </section>
            )}
