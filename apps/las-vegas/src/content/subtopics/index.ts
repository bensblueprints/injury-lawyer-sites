...
export const SUBTOPIC_ENTRIES: SubtopicEntry[] = [
  ...
  // Slip & Fall subtopics
  { parentSlug: "slip-and-fall-lawyer", slug: "casino-slip-fall", label: "Casino Slip & Fall" },
  ...
  { parentSlug: "pedestrian-accident-lawyer", slug: "strip-pedestrian-accident", label: "Las Vegas Strip Pedestrian Accidents" },
  // Bicycle subtopics
  ...
  // Bus subtopics
  { parentSlug: "bus-accident-lawyer", slug: "rtc-bus-accident", label: "RTC Bus Accidents" },
...
const stub = (entry: SubtopicEntry): SubtopicContent => ({
  ...
  title: entry.label,
  metaTitle: `${entry.label} in Las Vegas, NV | Las Vegas Injury Law Group`,
  metaDescription: `Injured in a ${entry.label.toLowerCase()} incident in Las Vegas? Our attorneys fight for maximum compensation. Free consultation. No fee unless we win. Call (702) 555-0147.`,
  intro: `Las Vegas Injury Law Group represents victims of ${entry.label.toLowerCase()} throughout Southern Nevada. If you or a loved one has been injured, our experienced attorneys are ready to evaluate your case and fight for every dollar you deserve.`,
  sections: [
    {
      heading: `Understanding ${entry.label} Claims in Nevada`,
      body: `${entry.label} cases require a thorough understanding of Nevada personal injury law, evidence preservation, and insurance company tactics. Our attorneys have handled hundreds of cases similar to yours and know exactly how to build a compelling claim.`,
    },
    {
      heading: "Compensation Available",
      body: `Victims of ${entry.label.toLowerCase()} incidents in Nevada may be entitled to compensation for medical expenses, lost income, pain and suffering, emotional distress, and more. Our attorneys evaluate every element of your damages to pursue the maximum recovery.`,
    },
    {
      heading: "Why Act Quickly",
      body: `Evidence disappears. Witnesses' memories fade. Insurance companies begin building their defense immediately. The sooner you contact us, the stronger your case will be. Call Las Vegas Injury Law Group at (702) 555-0147 today for a free consultation.`,
    },
  ],
  faqs: [
    {
      question: `What should I do after a ${entry.label.toLowerCase()} incident?`,
      answer: `Seek immediate medical attention, document the scene, gather witness information, and call Las Vegas Injury Law Group at (702) 555-0147 before speaking with any insurance company.`,
    },
    {
      question: "How much is my case worth?",
      answer:
        "Case value depends on the severity of your injuries, medical costs, lost wages, and the impact on your quality of life. Our attorneys provide a detailed, honest assessment during your free consultation.",
    },
  ],
});
