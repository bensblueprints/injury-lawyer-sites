...
export default function SubtopicPage({ params }: Props) {
  ...
  return (
    <>
      <HeroSection
        config={siteConfig}
        headline={`Omaha ${subtopicTitle}`}
        subheadline={`Experienced Omaha ${parent.title.toLowerCase()} attorneys handling ${subtopicTitle.toLowerCase()} cases throughout Eastern Nebraska. Free consultation — no fee unless we win.`}
        compact
      />
