...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://omahanebraskainjurylawyer.com/${content.slug}`,
    },
    openGraph: {
      title: content.metaTitle,
      description: content.metaDescription,
      url: `https://omahanebraskainjurylawyer.com/${content.slug}`,
    },
  };
}
    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <article className="lg:col-span-2 prose prose-lg max-w-none">
            ...
            <div className="not-prose my-8 rounded-xl overflow-hidden shadow-md">
              <Image
                ...
                alt={`${content.title} attorney in Omaha`}
                width={1536}
                height={1024}
            ...
            <div className="not-prose my-10">
              <CTABox
                config={siteConfig}
                headline={`Speak to an Omaha ${content.title} Now`}
        ...
        {content.relatedAreas.length > 0 && (
          <div className="mt-16">
            <RelatedPages
              heading="Other Omaha Injury Practice Areas"
