  ...
  return (
    <>
      <HeroSection
        ...
        subheadline={`Omaha Injury Law Group serves ${hood.name} injury victims with aggressive, results-driven representation. Free consultation — no fee unless we win.`}
        compact
      />
