    ...
    <>
      <PageHeroSection imageSrc="/images/courtroom.webp" imageAlt="Legal FAQ">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-300 max-w-3xl">Get clear, honest answers about Omaha personal injury law from experienced attorneys who fight for injury victims throughout Eastern Nebraska.</p>
