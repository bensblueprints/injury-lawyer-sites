...
export const metadata: Metadata = {
  title: "Free Consultation | Omaha Injury Law Group",
  description:
    "Request your free case consultation with Omaha Injury Law Group. No obligation. No upfront fees. We respond within 15 minutes. Call (402) 555-0167.",
  alternates: {
    canonical: "https://omahanebraskainjurylawyer.com/free-consultation",
  },
};
  ...
  return (
    <>
      <HeroSection
        ...
        subheadline="No obligation, no upfront fees. An Omaha injury attorney will review your case personally and explain your options. We respond within 15 minutes."
        compact
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Fill out the form below and an Omaha injury attorney will contact you within
