...
const LEGAL_PROCESS_TOPICS = [
  ...
  { slug: "filing-a-lawsuit-in-nebraska", title: "Filing a Lawsuit in Nebraska" },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!topic) return {};
  return {
    title: `${topic.title} | Omaha Injury Law Group`,
    description: `Learn about ${topic.title.toLowerCase()} from experienced Omaha personal injury attorneys. Free consultation. Call (402) 555-0167.`,
    alternates: { canonical: `https://omahanebraskainjurylawyer.com/legal-process/${params.topic}` },
  };
}
    ...
    <>
      <PageHeroSection imageSrc="/images/legal-process.webp" imageAlt="Legal process">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-300 max-w-3xl">Omaha Injury Law Group guides you through every step of the Nebraska personal injury legal process. We handle everything so you can focus on recovery.</p>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <article className="lg:col-span-2 prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 mb-8 not-prose">
              Understanding {topic.title.toLowerCase()} is essential for Omaha injury victims
              who want to protect their rights and maximize their compensation. Omaha Injury
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                Overview: {topic.title} in Nebraska
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Nebraska personal injury law governs how accident victims can seek compensation
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                How Omaha Injury Law Group Handles {topic.title}
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Our Omaha attorneys manage every aspect of {topic.title.toLowerCase()} on
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                Key Considerations Under Nebraska Law
              </h2>
              <p className="text-gray-700 leading-relaxed">
                Nebraska follows a modified comparative negligence rule (50% bar). The
                statute of limitations for most personal injury claims is four years. Nebraska
                allows recovery of both economic and non-economic damages. Our attorneys know
                how to navigate all of these factors to your advantage and fight for the
            ...
            <div className="not-prose mt-10">
              <CTABox
                ...
                body="Our Omaha attorneys explain every step in plain English. Free consultation — no obligation."
                variant="red"
              />
            </div>
          </article>
