  ...
  return (
    <>
      <HeroSection
        ...
        subheadline="Omaha Injury Law Group guides you through every step of the Nebraska personal injury legal process. We handle everything so you can focus on recovery."
        compact
      />
