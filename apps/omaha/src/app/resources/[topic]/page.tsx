...
const RESOURCE_TOPICS = [
  { slug: "what-to-do-after-car-accident", title: "What to Do After a Car Accident in Omaha" },
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: `${topic.title} — Free resource from Omaha Injury Law Group. Call (402) 555-0167 for a free case consultation.`,
    alternates: { canonical: `https://omahanebraskainjurylawyer.com/resources/${params.topic}` },
  };
}
    ...
    <>
      <PageHeroSection imageSrc="/images/attorney-consultation.webp" imageAlt="Legal resources">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg text-gray-300 max-w-3xl">Free resource from Omaha Injury Law Group — helping Eastern Nebraska injury victims understand their rights and options.</p>
        ...
        <div className="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-10">
          <article className="lg:col-span-2 prose prose-lg max-w-none">
            <p className="text-xl text-gray-700 mb-8 not-prose">
              Omaha Injury Law Group provides this free resource to help injury victims
              throughout Eastern Nebraska understand their rights and navigate the claims
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                Nebraska injury victims face unique challenges when pursuing compensation. Insurance
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-black text-gray-900 mb-3">
                How Omaha Injury Law Group Can Help
              </h2>
              <p className="text-gray-700 leading-relaxed">
                While these resources provide general guidance, every case is unique. Our Omaha
            ...
            <div className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed">
                ...
                to locate, and deadlines approach. If you&apos;ve been injured in Omaha or
                anywhere in Eastern Nebraska, contact us today for a free consultation.
            ...
            <div className="not-prose mt-10">
              <CTABox
                config={siteConfig}
                headline="Ready to Talk to an Omaha Attorney?"
